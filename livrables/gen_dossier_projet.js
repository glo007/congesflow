...
const figures = [
  ...
  tableau(["Réf.", "Figure", "Type"], [
    ...
    ["Fig.3a-3c", "Diagrammes d'activité (connexion, validation, annulation)", "UML"],
    ["Fig.4a-4b", "Diagrammes de séquence (connexion, validation)", "UML"],
...
const chap2 = [
  ...
  P(""),
  H3("2.4.1 Modélisation détaillée des principaux cas d'utilisation"),
  P("Afin d'obtenir une conception complète, chaque cas d'utilisation majeur est décrit par son diagramme d'activité et, lorsqu'il implique plusieurs échanges, par son diagramme de séquence. Les diagrammes de la création d'une demande figurent ci-dessus (Fig.3 et Fig.4)."),
  P("Cas d'utilisation « S'authentifier » (UC01) :", { run: { bold: true } }),
  diagram("Fig.3a", "Diagramme d'activité — s'authentifier", "11-activite-connexion.mmd"),
  P(""),
  diagram("Fig.4a", "Diagramme de séquence — s'authentifier", "12-sequence-connexion.mmd"),
  P(""),
  P("Cas d'utilisation « Valider ou refuser une demande » (UC03) :", { run: { bold: true } }),
  diagram("Fig.3b", "Diagramme d'activité — valider ou refuser une demande", "13-activite-validation.mmd"),
  P(""),
  diagram("Fig.4b", "Diagramme de séquence — valider une demande", "14-sequence-validation.mmd"),
  P(""),
  P("Cas d'utilisation « Annuler une demande » (UC04) :", { run: { bold: true } }),
  diagram("Fig.3c", "Diagramme d'activité — annuler une demande", "15-activite-annulation.mmd"),
  P(""),
  ...
  styles: {
    ...
    paragraphStyles: [
      { id: "Heading1", name: "Heading 1", basedOn: "Normal", next: "Normal", quickFormat: true,
        ...
        paragraph: { spacing: { before: 340, after: 200 }, outlineLevel: 0,
          shading: { type: ShadingType.CLEAR, fill: "0B5394" },
          border: { bottom: { style: BorderStyle.SINGLE, size: 18, color: "07386A", space: 6 } } } },
      { id: "Heading2", name: "Heading 2", basedOn: "Normal", next: "Normal", quickFormat: true,
        run: { size: 26, bold: true, color: "0B5394" },
        paragraph: { spacing: { before: 220, after: 120 }, outlineLevel: 1,
          border: { bottom: { style: BorderStyle.SINGLE, size: 6, color: "9DB8DA", space: 3 } } } },
